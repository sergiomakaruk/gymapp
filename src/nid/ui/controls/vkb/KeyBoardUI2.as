package nid.ui.controls.vkb 
{
	 ...
	 */
	public class KeyBoardUI2 extends Sprite
	{
		...
		= [	[{ c:'1', w:n_w, h:n_h , t:'L' }, 	  { c:'2', w:n_w, h:n_h , t:'L' }, { c:'3', w:n_w, h:n_h , t:'L' }, 	  { c:'4', w:n_w, h:n_h , t:'L' }, { c:'5', w:n_w, h:n_h , t:'L' }, { c:'6', w:n_w, h:n_h , t:'L' }, { c:'7', w:n_w, h:n_h , t:'L' }, { c:'8', w:n_w, h:n_h , t:'L' }, { c:'9', w:n_w, h:n_h , t:'L' }, { c:'0', w:n_w, h:n_h , t:'L' }],
			...
			[{ c:'@', w:n_w, h:n_h , t:'L' },{ c:'z', w:n_w, h:n_h , t:'L' }, { c:'x', w:n_w, h:n_h , t:'L' }, { c:'c', w:n_w, h:n_h , t:'L' }, { c:'v', w:n_w, h:n_h , t:'L' }, { c:'b', w:n_w, h:n_h , t:'L' }, { c:'n', w:n_w, h:n_h , t:'L' }, { c:'m', w:n_w, h:n_h , t:'L' }, { c:'{del}', w:del_w, h:del_h , t:'D' }],
			[ { c:'.', w:n_w, h:n_h , t:'L' },{ c:'_', w:n_w, h:n_h , t:'L' }, { c:'-', w:n_w, h:n_h , t:'L' },{ c:'Ok', w:enter_w, h:enter_h , t:'D' }]	];
			
		private var alphabets_upper:Array 
		= [	[{ c:'1', w:n_w, h:n_h , t:'L' }, 	  { c:'2', w:n_w, h:n_h , t:'L' }, { c:'3', w:n_w, h:n_h , t:'L' }, 	  { c:'4', w:n_w, h:n_h , t:'L' }, { c:'5', w:n_w, h:n_h , t:'L' }, { c:'6', w:n_w, h:n_h , t:'L' }, { c:'7', w:n_w, h:n_h , t:'L' }, { c:'8', w:n_w, h:n_h , t:'L' }, { c:'9', w:n_w, h:n_h , t:'L' }, { c:'0', w:n_w, h:n_h , t:'L' }],
			[ { c:'Q', w:n_w, h:n_h , t:'L' }, 		 { c:'W', w:n_w, h:n_h , t:'L' }, { c:'E', w:n_w, h:n_h , t:'L' }, 		 { c:'R', w:n_w, h:n_h , t:'L' }, { c:'T', w:n_w, h:n_h , t:'L' }, { c:'Y', w:n_w, h:n_h , t:'L' }, { c:'U', w:n_w, h:n_h , t:'L' }, { c:'I', w:n_w, h:n_h , t:'L' }, { c:'O', w:n_w, h:n_h , t:'L' }, { c:'P', w:n_w, h:n_h , t:'L' }], 
			[ { c:'A', w:n_w, h:n_h , t:'L' }, 		 { c:'S', w:n_w, h:n_h , t:'L' }, { c:'D', w:n_w, h:n_h , t:'L' }, 		 { c:'F', w:n_w, h:n_h , t:'L' }, { c:'G', w:n_w, h:n_h , t:'L' }, { c:'H', w:n_w, h:n_h , t:'L' }, { c:'J', w:n_w, h:n_h , t:'L' }, { c:'K', w:n_w, h:n_h , t:'L' }, { c:'L', w:n_w, h:n_h , t:'L' }], 
			[ { c:'Z', w:n_w, h:n_h , t:'L' }, { c:'X', w:n_w, h:n_h , t:'L' }, 		 { c:'C', w:n_w, h:n_h , t:'L' }, { c:'V', w:n_w, h:n_h , t:'L' }, { c:'B', w:n_w, h:n_h , t:'L' }, { c:'N', w:n_w, h:n_h , t:'L' }, { c:'M', w:n_w, h:n_h , t:'L' }, { c:'{del}', w:del_w, h:del_h , t:'D' }], 
			[ { c:'?123', w:abc_w, h:abc_h , t:'D' },  { c:'@', w:n_w, h:n_h , t:'L' }, { c:'{space}', w:space_w, h:space_h , t:'D' }, { c:'.', w:n_w, h:n_h , t:'D' }, { c:'enter', w:enter_w, h:enter_h , t:'D' }]	];
		...
		public function build(param:*=null):void
		{
			...
			var sp:Sprite = GetDrawedObjects.getSprite(_stage.stageWidth,_stage.stageHeight,0,0);
			addChildAt(sp,0);
			sp.y = -450;
