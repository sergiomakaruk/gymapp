package  nid.ui.controls
{
	...
	import nid.ui.controls.vkb.KeyBoardUIEjercicio;
	
	/**
	 * ...
	 * @author Nidin P Vinayakan
	 */
	public class VirtualKeyBoardEjercicio extends Sprite 
	{
		private static var instance:VirtualKeyBoardEjercicio;
		public static function getInstance():VirtualKeyBoardEjercicio
		{
			if (instance == null)
			{
				instance = new VirtualKeyBoardEjercicio();
			}
			return instance;
		}
		...
		public var keyboard:KeyBoardUIEjercicio;
		private var isActive:Boolean;
		
		private var _stage:Stage;
		
		public function VirtualKeyBoardEjercicio() 
		{
			configUI();
		...
		{
			keyboard = new KeyBoardUIEjercicio();
			addChild(keyboard );
		...
		public function show():void
		{
			...
			keyboard._stage = this._stage;
			keyboard.alpha = 0;
			_stage.addChild(keyboard);
			TweenMax.to(keyboard, 0.5,{ alpha:1, y:680, ease:Expo.easeOut } );
			isActive = true;
		}
		...
		private function flush():void
		{
			...
			if(keyboard.stage)	_stage.removeChild(keyboard);
		}
	}
