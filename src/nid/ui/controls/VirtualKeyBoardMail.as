package  nid.ui.controls
{
	...
	import nid.ui.controls.vkb.KeyBoardUIMail;
	
	/**
	 * ...
	 * @author Nidin P Vinayakan
	 */
	public class VirtualKeyBoardMail extends Sprite 
	{
		private static var instance:VirtualKeyBoardMail;
		public static function getInstance():VirtualKeyBoardMail
		{
			if (instance == null)
			{
				instance = new VirtualKeyBoardMail();
			}
			return instance;
		}
		...
		public var keyboard:KeyBoardUIMail;
		private var isActive:Boolean;
		
		private var _stage:Stage;
		
		public function VirtualKeyBoardMail() 
		{
			configUI();
		...
		public function show():void
		{
			...
			TweenMax.to(keyboard, 0.5,{ alpha:1, y:0, ease:Expo.easeOut } );
			isActive = true;
		}
