...
package app.sections.rutina
{
	...
	public class TapScroller extends Sprite
	{
		...
		public var scrollFactor:Number = 3;
			...
			height:Number)
		{
			...
			addEventListener(Event.REMOVED_FROM_STAGE, handleRemovedToStage);
		...
		private  function handleRemovedToStage(e:Event):void {
			removeEventListener(MouseEvent.MOUSE_DOWN, handleMouseDown);
			removeEventListener(Event.ENTER_FRAME, handleEnterFrame);
			removeEventListener(Event.REMOVED_FROM_STAGE, handleAddedToStage);
		}
		...
		private function handleMouseMove(e:MouseEvent):void {
			...
			if(firstPos.y != e.localY)this.mouseChildren = false;
